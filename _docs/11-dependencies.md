...
covers the {{ site.data.dependencies.repos.CANlab_help_examples.scripts | size }}
second-level templates LaBGAS actively maintains rather than the ~113 scripts present.
